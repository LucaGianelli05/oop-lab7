...
public final class Transformers {
    ...
    public static <I, O> List<O> transform(final Iterable<I> base, final Function<I, O> transformer) {
        Objects.requireNonNull(base, "base must be not null");
        Objects.requireNonNull(transformer, "transformer must be not null");
        final List<O> transformedList = new ArrayList<>();
    ...
    public static <I> List<? extends I> flatten(final Iterable<? extends Collection<? extends I>> base) {
        ...
        for (final var collection : base) {
            elements.addAll(transform(collection, Function.identity()));
        }
        return elements;
    }
    ...
    public static <I> List<I> select(final Iterable<I> base, final Function<I, Boolean> test) {
        Objects.requireNonNull(base, "base must be not null");
        Objects.requireNonNull(test, "test must be not null");
        final List<I> elements = new ArrayList<>();
        for (final var element : base) {
